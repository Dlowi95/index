...
<div class="container ">
    <div class="row " style="margin: 50px auto;">
        <legend class="text-center text-uppercase fw-bold">Thêm người dùng</legend>
        <?php
    if(!empty($smg)){
        getSmg($smg,$smg_type);
    }
    ?>
        <form action="" method="post">
            ...
            <button type="submit" class="btn btn-primary btn-block mg-form mg-btn-add">Thêm người dùng</button>
